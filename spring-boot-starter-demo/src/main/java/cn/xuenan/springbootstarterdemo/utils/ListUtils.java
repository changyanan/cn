package cn.xuenan.springbootstarterdemo.utils;
 ...
 * @author changyanan1
 */
public class ListUtils<T> implements Serializable {
...
//        List<String> list = ListUtils.n("1", "2", "3", "4", "5", "6").to();
//        System.out.println(Mono.just(list.toString().hashCode()));
//        Map<String, String> maps = MapUtils.<String, String>n().a("k1", "v1").a("k2", "v2").to();
//        List<String> to = MapUtils.n(maps).array((k, v) -> v).to();
//        System.out.println(to);
//        Mono.just(maps).block();
        System.out.println("//SUCCESS[6.712s]/./SUCCESS[0.119]/./[0.218]//\n" +
                "//SUCCESS[3.712s]/./SUCCESS[0.119]/./[0.218]//\n" +
                "//SUCCESS[0.112s]/./SUCCESS[0.119]/./[0.218]//\n" +
                "//SUCCESS[0.512s]/./SUCCESS[0.119]/./[0.218]//\n" +
                "//SUCCESS[0.212s]/./SUCCESS[0.119]/./[0.218]//\n" +
                "//SUCCESS[0.112s]/./SUCCESS[0.119]/./[0.218]//\n" +
                "//SUCCESS[1.512s]/./SUCCESS[0.119]/./[0.218]//\n" +
                "//SUCCESS[1.812s]/./SUCCESS[0.119]/./[0.218]//\n" +
                "//SUCCESS[0.512s]/./SUCCESS[0.119]/./[0.218]//\n" +
                "//SUCCESS[0.512s]/./SUCCESS[0.119]/./[0.218]//\n" +
                "//SUCCESS[0.612s]/./SUCCESS[0.119]/./[0.218]//\n" +
                "//SUCCESS[0.312s]/./SUCCESS[0.119]/./[0.218]//");
    }
}
